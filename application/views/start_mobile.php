...
<div class="contain">
    <div class="home">
        <div class="divbg"><img src="<?=$this->config->base_url()?>static/mobile/images/nybox.jpg"/></div>
        <div class="ny_head"><img src="<?=$this->config->base_url()?>static/mobile/images/top.jpg"/></div>
        <!--创建信息 开始-->
        ...
        <div id="popDiv3" class="mydiv" style="display:none;">
            <div class="popdiv2">
                <img src="<?=$this->config->base_url()?>static/mobile/images/pop3.png"/>
