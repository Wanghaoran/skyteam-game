    ...
    <div class="tab_kol">
        <div class="tab_koltitle">
            <ul>
                ...
                <li class="on"><a onclick="_gaq.push(['_trackEvent', 'KOL', 'TabClick', 'GoToShowWizard']);" href="<?=$this->config->base_url()?>wizard_show"><img src="<?=$this->config->base_url()?>static/pc/images/tab_text3.png"/></a></li>
            </ul>
            <div class="clear"></div>
        </div>
