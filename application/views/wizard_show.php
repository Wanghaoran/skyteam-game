...
<div class="ny_content2">
    <div class="tab_kol">
        <div class="tab_koltitle">
            <ul>
                <li><a onclick="_gaq.push(['_trackEvent', 'KOL', 'TabClick', 'GoToFoodWizard']);_smq.push(['custom','GoToFoodWizard','TabClick']);" href="<?=$this->config->base_url()?>wizard_food"><img src="<?=$this->config->base_url()?>static/pc/images/tab_text1.png"/></a></li>
                ...
                <li class="on"><a onclick="_gaq.push(['_trackEvent', 'KOL', 'TabClick', 'GoToShowWizard']);_smq.push(['custom','GoToShowWizard','TabClick']);" href="<?=$this->config->base_url()?>wizard_show"><img src="<?=$this->config->base_url()?>static/pc/images/tab_text3.png"/></a></li>
            </ul>
            <div class="clear"></div>
        </div>
