...
<div id="popDiv4" class="mydiv2" style="display:none;">
    <div class="popdiv2">
        ...
        <div class="div_iframe">
            <iframe width="100%" height="100%" class="share_self"  frameborder="0" scrolling="no" id="sinaweibo">
...
<div class="contain">
    <div class="home">
        ...
        <div class="right">
            <ul>
                <li>
                    <div class="divliimg"><a href="#"><img src="<?=$this->config->base_url()?>static/pc/images/rightbtn.png"/></a></div>
                    <div class="divinfo">
                        <div class="adminimg"><a href="#"><img src="<?=$this->config->base_url()?>static/pc/images/adminimg.png"/></a></div>
                        <div class="textimg"><a href="#"><h2>天巡星导游之美食团</h2><h3>微博达人陛下</h3></a></div>
                    </div>
                </li>
                <li>
                    <div class="divliimg"><a href="#"><img src="<?=$this->config->base_url()?>static/pc/images/rightbtn.png"/></a></div>
        ...
        <div class="bottom">
            ...
            <div class="bottom_right">
                ...
                <div class="bottom_bot">
                    ...
                    <div class="sina">
                        <wb:follow-button uid="3353187630" type="red_4" >关注按钮</wb:follow-button>
                    </div>
                    <div class="linktext">
                        <a href="<?=$this->config->base_url()?>welcome/rank" class="phb" title="天团排行榜"><img src="<?=$this->config->base_url()?>static/pc/images/textphb.png"/></a><a href="#" class="hdgz" title="活动规则"><img src="<?=$this->config->base_url()?>static/pc/images/texthdgz.png"/></a>
                    </div>
                    <div class="iconlink">
                        ...
                        <a href="javascript:shareDouban();"><img src="<?=$this->config->base_url()?>static/pc/images/icon_douban.png"/></a>
                        <div class="text1">
