        ...
        <div class="tab_kol">
            <div class="tab_koltitle">
                <ul>
                    ...
                    <li><a onclick="_smq.push(['custom','GoToFoodWizard','TabClick']);" href="<?=$this->config->base_url()?>wizard_food"><img src="<?=$this->config->base_url()?>static/mobile/images/tab_mston.png"/></a></li>
            ...
            <div class="tab_kolcon">
                <div class="tab_kol_info">
                    ...
                    <div class="divleft">
                        <img src="http://tp2.sinaimg.cn/1684322821/180/5703294246/1"/>
                </div>
                    <div class="divright">
