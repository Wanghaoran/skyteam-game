...
<head>
    ...
    <script type="text/javascript">
        ...
        function showNext(){
            ...
            _gaq.push(['_trackEvent', 'TeamCreation', 'ButtonClick', 'CreateTeam']);
        ...
        $(function(){
            ...
            $(".xinlang").click(function() {
                ...
                _gaq.push(['_trackEvent', 'TeamCreation', 'ButtonClick', 'SelectDestinationSydney']);
                _smq.push(['custom','SelectDestination','ButtonClick']);
                ...
                $.ajax({
                    ...
                    success : function(ress){
                        ...
                        $.ajax({
                            ...
                            var text_weibo = '约吗？我已经组团参加了@Skyscanner天巡＃起飞吧朋友＃抢12万元旅行红包活动！是朋友就快来加入贡献里程给我！去度假、去逛吃、去扫货，一起赢！整！团！机！票！臭宝贝们证明友情的时候到了！跟别的团死磕去→猛戳参与活动' + url2 + '得分第一名就一起飞！';
            ...
            <div class="chkbox" id="chklist">
                <ul>
                    <?php foreach($friend_result['users'] as $key => $value):?>
                        <li><input type="checkbox" value='<?=$value['name']?>' /><label><div class="divimg"><span>&nbsp;</span><img width="63" src="<?=$value['avatar_large']?>"/></div><div class="divtext" style="overflow:hidden;"><?=$value['name']?></div></label></li>
                    <?php endforeach;?>
                </ul>
            </div>
        </div>
